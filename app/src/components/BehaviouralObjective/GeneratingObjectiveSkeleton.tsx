...
import type { ObjectiveColor } from "./types";

type GeneratingObjectiveSkeletonProps = {
  number: number;
  color: ObjectiveColor;
};

const colorConfig: Record<ObjectiveColor, string> = {
  teal: "bg-[#0d9488]",
  cyan: "bg-[#0891b2]",
  blue: "bg-[#0284c7]",
  indigo: "bg-[#4f46e5]",
...
export function GeneratingObjectiveSkeleton({ number, color }: GeneratingObjectiveSkeletonProps) {
  return (
