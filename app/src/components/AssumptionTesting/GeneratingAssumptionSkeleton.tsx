...
import type { AssumptionColor } from "./types";

type GeneratingAssumptionSkeletonProps = {
  number: number;
  color: AssumptionColor;
};

const colorConfig: Record<AssumptionColor, string> = {
  teal: "bg-[#0d9488]",
  cyan: "bg-[#0891b2]",
  blue: "bg-[#0284c7]",
  indigo: "bg-[#4f46e5]",
...
export function GeneratingAssumptionSkeleton({ number, color }: GeneratingAssumptionSkeletonProps) {
  return (
