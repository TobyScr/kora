...
type DeleteAssumptionModalProps = {
  isOpen: boolean;
  onClose: () => void;
  onDelete: () => void;
};
...
export function DeleteAssumptionModal({
  isOpen,
  onClose,
  onDelete,
}: DeleteAssumptionModalProps) {
  const handleDelete = () => {
    onDelete();
    onClose();
  };
    ...
    <Modal isOpen={isOpen} onClose={onClose} width={400}>
      ...
      <ModalBody>
        <p className="text-sm text-text-secondary leading-relaxed">
          Are you sure you want to delete this Assumption? This action cannot be
          undone.
        </p>
      </ModalBody>
